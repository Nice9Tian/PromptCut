    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "site": {
          ...
          "description": "默认 bilibili"
        },
        "limit": {
          "type": "number",
          "description": "最多几条,1~10,默认 5"
        }
      },
      "required": [
        "query"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "site": {
          ...
          "description": "站点预设,默认 auto 按链接判断"
        },
        "quality": {
          "type": "number",
          "description": "清晰度上限(像素高度),只认 2160 / 1440 / 1080 / 720 / 480 / 360,别的值按 1080 处理"
        }
      },
      "required": [
        "url"
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "quality": {
          "type": "number",
          "description": "清晰度上限(像素高度),默认 1080;只认 2160 / 1440 / 1080 / 720 / 480 / 360,别的值按 1080 处理"
        },
        "site": {
          "type": "string",
          "enum": [
        ...
        "audioOnly": {
          "type": "boolean",
          "description": "只要音频(m4a)"
        },
        "allParts": {
          "type": "boolean",
          "description": "多 P 稿件全部下载"
        },
        "keepCodec": {
          "type": "boolean",
          "description": "true 表示不把 HEVC / AV1 转成 H.264(默认会转,浏览器预览才稳)"
        },
        "cookies": {
          "type": "string",
          "description": "一般不用传:collect_login 存下的登录态会自动带上。要传只认应用数据目录 cookies/ 下的文件,别处的路径会被忽略"
        }
      },
      "required": [
        "url"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "method": {
          ...
          "description": "qr 扫码(默认);browser 打开站点登录页,账号密码 / 短信也行"
        },
        "force": {
          "type": "boolean",
          "description": "已登录也强制重新登录(换账号时用)"
        }
      }
    },
    "side": "browser"
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "hide": {
          "type": "boolean",
          "description": "登录成功后是否把窗口藏回屏幕外,默认 true"
        }
      }
    },
    "side": "browser"
