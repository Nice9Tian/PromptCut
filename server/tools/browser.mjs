export const browserTools = [
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "url": {
          "type": "string",
          "description": "完整链接；不带协议时按 https 补"
        }
      },
      "required": [
        "url"
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "u": {
          "type": "string",
          "description": "clickable 清单里的编号，如 e7"
        },
        "x": {
          "type": "number",
          "description": "图上的横坐标（像素）"
        },
        "y": {
          "type": "number",
          "description": "图上的纵坐标（像素）"
        },
        "expect": {
          "type": "string",
          "description": "你要点的元素上的文字。用 x,y 时几乎总该带上"
        }
      }
    },
    "side": "browser"
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "reason": {
          "type": "string",
          "description": "为什么要交给用户，会显示在提示里，如「B 站扫码登录」"
        },
        "hide": {
          "type": "boolean",
          "description": "true 表示把窗口藏回屏幕外"
        }
      }
    },
    "side": "browser"
