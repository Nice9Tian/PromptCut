  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "value": {
                ...
                "description": "数字,或含 t / d / p / 参数名的表达式字符串"
              }
            },
            "required": [
              "kind",
        ...
        "clipId": {
          "type": "string",
          "description": "可选:建完直接挂到这一段(视频 / 图片)"
        },
        "clipParams": {
          "type": "object",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "filterId": {
          "type": "string",
          "description": "空字符串 = 摘掉这一段的滤镜"
        },
        "params": {
          "type": "object",
          "description": "可选:这一段的参数值,只能是这个滤镜 params 里声明过的"
        }
      },
      "required": [
        "clipId",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "source": {
          "type": "object",
          "description": "映射输入媒体，可含 mediaId、stage(origin/after_filters)、filterId"
        },
        "where": {
          "type": "string",
          "description": "0~1 选区表达式，变量 r/g/b/a/luma/x/y/t"
        },
        "to": {
          "description": "目标可写字符串 '#ff0000'、'transparent'、素材 id，也可写 media/color/transparent/expr 对象；使用 colorSequence 时可省略"
        },
        "mode": {
          "type": "string",
          "enum": [
        ...
        "colorSequence": {
          "type": "object",
          "description": "可选 from/to 颜色序列及 mode"
        },
        "clipId": {
          "type": "string"
        }
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "to": {
          "description": "字符串颜色/transparent/素材 id，或目标对象"
        },
        "mode": {
          "type": "string",
          "enum": [
