 ...
 *   http-transport.mjs 同一形状的 HTTP 长轮询端点与仿 WebSocket 的类(只放行 443 HTTPS 的节点用,`docs/plan/http-transport-contract.md`)
 ...
 * `WebSocket` 与计时器(都可注入;`http-transport.mjs` 同样,换成全局 `fetch`),`endpoint.mjs` 缺省读 `process.env`、用全局 `fetch`(都可注入),
