...
export function TimelineProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      if (e.ctrlKey) {
        ...
        const newScrollLeft = timeAtPointer * newPxPerSec - (e.clientX - rect.left - 200);
        setTimeout(() => {
  ...
  return (
    <TimelineContext.Provider value={{ pxPerSec, setPxPerSec, scrollRef, trackAreaRef, draggingClipId, setDraggingClipId, draggingTrackId, setDraggingTrackId }}>
      {children}
