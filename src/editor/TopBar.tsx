...
export function TopBar() {
  ...
  return (
    <div className="flex items-center gap-2 px-3 h-11 border-b border-neutral-800 text-sm">
      <span className="font-semibold tracking-wide">PromptCut</span>
      ...
      <select value={themeId} onChange={(e) => actions.setProjectMeta({ themeId: e.target.value })} className="bg-neutral-800 rounded px-2 py-1 text-xs">
        {themes.map((th) => (
